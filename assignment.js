...
// var a = [1,2,3,3,4,5,5]
// let duplicates = (n) => {
//  let k= new Set([...n]) NOW IT WILL LIKE OBJECT
//  let final=Array.from(k) OBJECT COBERT TO ARRAY
//  console.log(final);
// }
// duplicates(a
...
function names(a,b) {
  let unionObjects=new Set ([...a,...b]) 
  let unionArray = Array.from(unionObjects);
  return  unionArray
}

 let result = names(a,b)
 console.log(result);
